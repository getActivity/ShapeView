...
public class ShapeRecyclerView extends RecyclerView implements IShapeDrawable<ShapeRecyclerView> {
    ...
    public ShapeRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mShape = typedArray.getInt(R.styleable.ShapeRecyclerView_shape, DEFAULT_SHAPE);
        ...
        mStartColor = typedArray.getColor(R.styleable.ShapeRecyclerView_shape_startColor, DEFAULT_SHAPE_START_COLOR);
        mCenterColor = typedArray.getColor(R.styleable.ShapeRecyclerView_shape_centerColor, DEFAULT_SHAPE_CENTER_COLOR);
        mEndColor = typedArray.getColor(R.styleable.ShapeRecyclerView_shape_endColor, DEFAULT_SHAPE_END_COLOR);
        ...
        mCenterY = typedArray.getFloat(R.styleable.ShapeRecyclerView_shape_centerX, DEFAULT_SHAPE_CENTER_Y);
        ...
        mDashWidth = (int) typedArray.getDimension(R.styleable.ShapeRecyclerView_shape_dashWidth, DEFAULT_SHAPE_DASH_WIDTH);
        mDashGap = (int) typedArray.getDimension(R.styleable.ShapeRecyclerView_shape_dashGap, DEFAULT_SHAPE_DASH_GAP);
    ...
    @Override
    public ShapeRecyclerView setShape(int shape) {
        mShape = shape;
        return this;
    }
