...
public final class ShapeImageViewStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidStartColorStyleable() {
        return R.styleable.ShapeImageView_shape_solidStartColor;
    }

    @Override
    public int getSolidCenterColorStyleable() {
        return R.styleable.ShapeImageView_shape_solidCenterColor;
    }

    @Override
    public int getSolidEndColorStyleable() {
        return R.styleable.ShapeImageView_shape_solidEndColor;
    }
    ...
    public int getSolidCenterXStyleable() {
        return R.styleable.ShapeImageView_shape_solidCenterX;
    }

    @Override
    public int getSolidCenterYStyleable() {
        return R.styleable.ShapeImageView_shape_solidCenterY;
    }
